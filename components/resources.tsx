    ...
    const featuredCell = (src: string, alt: string, title: string, desc: string, link: string) => {
        return <div className="bg-stone-100 space-y-2 overflow-clip rounded-md flex flex-col justify-between border border-gray-300">
            ...
            <Link props={{
                ...
                isExternal: true,
                className: "bg-acc-200 w-full py-2 md:hover:bg-acc transition-all text-bg text-center md:text-lg font-medium"
            }} />
        </div>
    }

    return <div className="mt-4 md:my-4 md:mx-8">
        ...
        <div className="grid place-items-center pt-4">
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 max-w-[800px]">
